# FU TÜRKÇE Terminoloji Sözlüğü

Durumlar: PROPOSED, APPROVED, REVIEW, LOCKED.

| Kaynak | Bağlam | Tür | Onaylı Türkçe | Kullanılmayacak | Durum | Not |
|---|---|---|---|---|---|---|
| Research | Sistem / isim | Sistem | Araştırma | İnceleme, Bilim, Research | LOCKED | FU araştırma sisteminin adı |
| Research | Buton / eylem | Eylem | Araştır | İncele | LOCKED | UI eylemi |
| Tier | Seviye gösterimi | Sistem | Kademe | Tier | LOCKED | Araştırma kademeleri |
| Geology | Araştırma ağacı | Sistem | Jeoloji | Geology | LOCKED | |
...
| Tinkering Table | Makine | Nesne | İnce İşçilik Tezgâhı | Tinkering Table | LOCKED | |
| Foraging Table | Makine | Nesne | Toplayıcılık Tezgâhı | Foraging Table | LOCKED | |
| Science Outpost | Yer | Yer | Bilim Karakolu | Science Outpost | LOCKED | |
| Personal Tricorder | Eşya | Nesne | Kişisel Tricorder | Personal Tricorder | LOCKED | Tricorder özel ürün adı olarak korunur |
| Matter Manipulator | Eşya | Nesne | Madde Manipülatörü | Matter Manipulator | LOCKED | |
| Furnace | Makine | Nesne | Fırın | Furnace | LOCKED | |
| Greenhouse | Makine | Nesne | Sera | Greenhouse | LOCKED | |
...
| Dark Cavern | Görev yeri | Yer | Karanlık Mağara | Dark Cavern | APPROVED | |
...
| Drone / Drone Bee | Arıcılık rolü | Terim | Erkek Arı | Drone | LOCKED | Türkçe arıcılık terminolojisi |
| Honey Queen | Arı eşyası | Nesne | Bal Ana Arısı | Honey Queen | LOCKED | |
| Honey Drone | Arı eşyası | Nesne | Bal Erkek Arısı | Honey Drone | LOCKED | |
| Basic Microscope | Arıcılık makinesi | Nesne | Temel Mikroskop | Basic Microscope | LOCKED | |
| Honeycomb | Arıcılık kaynağı | Kaynak | Bal Peteği | Honeycomb | LOCKED | |
| Beeswax | Arıcılık kaynağı | Kaynak | Balmumu | Beeswax | LOCKED | |
| Large Apiary | Arıcılık yapısı | Nesne | Büyük Arılık | Alveary, Giant Apiary | LOCKED | Gerçek normalalveary envanter adı |
| Honey Jarring Machine / Honey Jarrer | Arıcılık makinesi | Nesne | Bal Kavanozlama Makinesi | Honey Jarrer | LOCKED | |
| Tungsten Frame | Arıcılık çerçevesi | Nesne | Tungsten Çerçeve | Tungsten Frame | LOCKED | |
| Golden Wood | Arıcılık malzemesi | Kaynak | Altın Odun | Golden Wood | LOCKED | |
| Orchid Queen | Arı eşyası | Nesne | Orkide Ana Arısı | Orchid Queen | LOCKED | |
