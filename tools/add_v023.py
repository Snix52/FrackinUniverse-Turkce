...
TR = {
    ...
    "durasteelshotgun": ("Durasteel Pompalı Tüfek", "Yakın mesafede ölümcül saçmalar ateşler."),
    "durasteelsniperrifle": ("Durasteel Keskin Nişancı Tüfeği", "Uzun mesafelerde etkili olacak kadar güçlü."),
