...
V041_UI_FIELDS = {(row['asset'], row['pointer']) for row in _V041_MANIFEST['translations']}
if len(V041_UI_FIELDS) != len(_V041_MANIFEST['translations']):
    raise ValueError('v0.41 geniş arayüz manifestinde yinelenen alan var')
