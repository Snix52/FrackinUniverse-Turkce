...
function init()
	...
	if recognized then
		...
		widget.setText("racialLabel", "TANINMAYAN IRK")
	end
end
...
function populateRacialDescription(race,notRecognized)
	...
	local JSON = (notRecognized and {charCreationTooltip={description="Bunun bir hata olduğunu düşünüyorsan SAIL'deki '^cyan;DİĞER^reset;' sekmesini kontrol et."}}) or root.assetJson("/species/"..race..".species")
	...
	widget.setText("racialLabel", "Irk Özellikleri - " .. racialName)
